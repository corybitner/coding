...
function hap_html_modern($preset, $wrapper_id, $options){
            ...
            <div class="hap-player-wrap">
                ...
                <div class="hap-player-holder">
                    ...
                    <div class="hap-player-thumb-wrapper">
                        ...
                        <div class="hap-circle-player" data-stroke-size="20">
                            <canvas class="hap-load-canvas" width="160" height="160" data-color="'.$options["seekbarBgColor"].'"></canvas>
                            <canvas class="hap-progress-canvas" width="160" height="160" data-color="'.$options["seekbarProgressColor"].'"></canvas>
                ...
                $markup .= '<div class="hap-playlist-holder">';
                    ...
                    <div class="hap-bottom-bar">';
                        ...
                        if($options["useSearch"])$markup .= '<input class="hap-search-filter" authap-search-filter" autocapitalize="none" type="text" placeholder="'.esc_html($options["filterText"]).'">';
