...
function hap_html_fixed($preset, $wrapper_id, $options){
	...
	$markup = '<div id="'.$wrapper_id.'" class="hap-music-player hap-'.$preset.'">
        ...
        <div class="hap-player-outer">
            ...
            <div class="hap-player-holder">
                ...
                <div class="hap-player-toggle-ex hap-contr-btn">
            ...
            if($options["usePlaylist"]){
                ...
                $markup .= '<div class="hap-playlist-holder">';
                    ...
                    $markup .= '<div class="hap-playlist-bar">';
                        ...
                        <div class="hap-playlist-bar-controls-right">';
                            ...
                            $markup .= '<div class="hap-random-toggle hap-contr-btn">
                                ...
                                <div class="hap-btn hap-btn-random-on hap-contr-btn-hover" data-tooltip="'.esc_attr($options["tooltipShuffleOn"]).'n">
                                    <svg role="img" viewBox="0 0 512 512"><path d="M504.971 359.029c9.373 9.373 9.373 24.569 0 33.941l-80 79.984c-15.01 15.01-40.971 4.49-40.971-16.971V416h-58.785a12.004 12.004 0 0 1-8.773-3.812l-70.556-75.596 53.333-57.143L352 336h32v-39.981c0-21.438 25.943-31.998 40.971-16.971l80 79.981zM12 176h84l52.781 56.551 53.333-57.143-70.556-75.596A11.999 11.999 0 0 0 122.785 96H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12zm372 0v39.984c0 21.46 25.961 31.98 40.971 16.971l80-79.984c9.373-9.373 9.373-24.569 0-33.941l-80-79.981C409.943 24.021 384 34.582 384 56.019V96h-58.785a12.004 12.004 0 0 0-8.773 3.812L96 336H12c-6.627 0-12 5.373-12 12v56c0 6.627 5.373 12 12 12h110.785c3.326 0 6.503-1.381 8.773-3.812L352 176h32z"></path></svg>
                                </div>
                            </div>';
                            ...
                            if($options["useRange"])$markup .= '<div class="hap-range-toggle hap-contr-btn" data-tooltip="'.esc_attr($options["tooltipRange"]).'">
                                <svg style="height:20px;" viewBox="0 0 24 24"><path d="M12.516 8.016v4.219l3.469 2.109-0.703 1.219-4.266-2.578v-4.969h1.5zM21 10.125h-6.797l2.766-2.813q-2.063-2.063-4.945-2.086t-4.945 1.992q-0.844 0.844-1.453 2.273t-0.609 2.602 0.609 2.602 1.453 2.273 2.297 1.453 2.625 0.609 2.648-0.609 2.32-1.453q2.016-2.016 2.016-4.875h2.016q0 3.703-2.625 6.281-2.625 2.625-6.375 2.625t-6.375-2.625q-2.625-2.578-2.625-6.258t2.625-6.305q1.078-1.078 2.93-1.852t3.398-0.773 3.398 0.773 2.93 1.852l2.719-2.813v7.125z"></path></svg>
                            </div>';
