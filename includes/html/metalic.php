...
function hap_html_metalic($preset, $wrapper_id, $options){

	$markup = '<div id="'.$wrapper_id.'" class="hap-music-player hap-metalic hap-'.$preset.'">

        <div class="hap-player-outer">

		<div class="hap-player-image"></div>

            <div class="hap-player-bg"></div>
            ...
            <div class="hap-player-outer">
                ...
                $markup .= '<div class="hap-playlist-holder">';
                    ...
                    <div class="hap-bottom-bar">';
                        ...
                        if($options["useSearch"])$markup .= '<input class="hap-search-filter" autocapitalize="none" type="text" placeholder="'.esc_html($options["filterText"]).'">';
                        ...
                        <div class="hap-bottom-bar-controls">';
                            ...
                            if($options["useRange"])$markup .= '<div class="hap-range-toggle hap-contr-btn" data-tooltip="'.esc_attr($options["tooltipRange"]).'">
                                <svg style="height:23px;" viewBox="0 0 24 24"><path d="M12.516 8.016v4.219l3.469 2.109-0.703 1.219-4.266-2.578v-4.969h1.5zM21 10.125h-6.797l2.766-2.813q-2.063-2.063-4.945-2.086t-4.945 1.992q-0.844 0.844-1.453 2.273t-0.609 2.602 0.609 2.602 1.453 2.273 2.297 1.453 2.625 0.609 2.648-0.609 2.32-1.453q2.016-2.016 2.016-4.875h2.016q0 3.703-2.625 6.281-2.625 2.625-6.375 2.625t-6.375-2.625q-2.625-2.578-2.625-6.258t2.625-6.305q1.078-1.078 2.93-1.852t3.398-0.773 3.398 0.773 2.93 1.852l2.719-2.813v7.125z"></path></svg>
                            </div>';
