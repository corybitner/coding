...
function hap_html_tiny($preset, $wrapper_id, $options){

    if($preset == 'tiny_dark_1' || $preset == 'tiny_light_1'){
        
        if(strpos($preset, 'dark') !== false)$preset = 'tiny-dark';
        else if(strpos($preset, 'light') !== false)$preset = 'tiny-light';

	    $markup = '<div id="'.$wrapper_id.'" class="hap-music-player hap-tiny hap-tiny1 hap-'.$preset.'">
    ...
    else if($preset == 'tiny_dark_2' || $preset == 'tiny_light_2'){

        if(strpos($preset, 'dark') !== false)$preset = 'tiny-dark';
        else if(strpos($preset, 'light') !== false)$preset = 'tiny-light';

        $markup = '<div id="'.$wrapper_id.'" class="hap-music-player hap-tiny hap-tiny2 hap-'.$preset.'">
    ...
    else if($preset == 'tiny_dark_3' || $preset == 'tiny_light_3'){   

        if(strpos($preset, 'dark') !== false)$preset = 'tiny-dark';
        else if(strpos($preset, 'light') !== false)$preset = 'tiny-light';
        $preset .= ' hap-tiny'; 

        $markup = '<div id="'.$wrapper_id.'" class="hap-music-player hap-tiny hap-tiny3 hap-'.$preset.'">
